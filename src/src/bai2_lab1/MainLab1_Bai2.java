...
public class MainLab1_Bai2 {
    public static void main(String[] args) {
        ...
        // PHẦN II: Ứng dụng AI
// Bài 3: Sử dụng AI tạo dữ liệu mẫu
...
// Dữ liệu lỗi:
ListEmployee.add(new FullTimeEmployee("", "Invalid Employee", 5000, 1000, 200)); 
// lỗi id rỗng

ListEmployee.add(new FullTimeEmployee("FT003", "Error Salary", -5000, 1000, 200)); 
// lỗi basicSalary âm

ListEmployee.add(new PartTimeEmployee("PT003", "Error Hour", 0, -10, 20)); 
// lỗi workingHours âm

ListEmployee.add(new PartTimeEmployee("PT004", "Error Rate", 0, 30, -15)); 
// lỗi hourlyRate âm
    }
